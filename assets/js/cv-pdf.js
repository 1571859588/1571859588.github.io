...
function downloadCV(filename) {
  ...
  var jobSpecific = [
    ...
    '    align-items: center !important; margin-bottom: 4px !important; padding-bottom: 4px !important;',
    '    border-bottom: 2px solid #2e8b9e !important;',
    '  }',
    '  .cv-header--job .cv-photo {',
    '    display: block !important; position: absolute !important; top: 0 !important; right: 0 !important;',
    '  }',
    '  .cv-header--job .cv-photo img {',
    '    width: 56px !important; height: 72px !important;',
    '    object-fit: cover !important; border: 1px solid #ccc !important;',
    '  }',
    '  .cv-name {',
    '    font-size: 16px !important; font-weight: 700 !important; text-align: center !important;',
    '    margin: 0 0 2px 0 !important; padding: 0 64px 0 0 !important; color: #111 !important;',
    '    border-bottom: none !important;',
    '  }',
    '  .cv-contact--job {',
    '    display: flex !important; flex-wrap: wrap !important; justify-content: center !important;',
    '    gap: 0 4px !important; font-size: 8px !important; color: #555 !important;',
    '    margin-bottom: 2px !important; padding: 0 64px 0 0 !important;',
    '  }',
    ...
    '    text-align: center !important; padding: 0 64px 0 0 !important; }',
