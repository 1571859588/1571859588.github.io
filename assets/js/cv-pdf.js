...
function downloadCV(filename) {
  ...
  var jobSpecific = [
    ...
    '    border-bottom: 2px solid #2e8b9e !important;',
    '  }',
    '  .cv-header--job .cv-header-info {',
    '    display: flex !important; flex-direction: row !important;',
    '    align-items: flex-start !important; gap: 1em !important;',
    '  }',
    '  .cv-header-text { flex: 1 1 auto !important; min-width: 0 !important; }',
    '  .cv-photo--job { flex: 0 0 auto !important; }',
    '  .cv-photo--job img {',
