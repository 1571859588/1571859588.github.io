...
function downloadCV(filename) {
  ...
  var jobSpecific = [
    ...
    '    border-bottom: 2px solid #2e8b9e !important;',
    '  }',
    '  .cv-header--job .cv-header-info { overflow: hidden !important; }',
    '  .cv-photo--job { float: right !important; margin-left: 10px !important; }',
    '  .cv-photo--job img {',
    '    width: 60px !important; height: 78px !important;',
    '    object-fit: cover !important; border: 1px solid #ccc !important;',
    '  }',
    '  .cv-header-text { overflow: hidden !important; }',
    '  .cv-name {',
